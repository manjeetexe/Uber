      ...
      <div className="p-7 flex flex-col justify-between h-screen">
        <div>
          ...
          <p className="text-center text-base mt-4">
            New here?{' '}
            <Link to="/userSignup" className="text-blue-400">
              Create new Account
            </Link>
          </p>
        </div>
        <div>
          <Link
            to="/captainLogin"
            className="bg-green-500 flex items-center justify-center font-bold text-white rounded px-4 py-3 w-full text-xl placeholder:text-base"
          >
            Signup as Captain
          </Link>
        </div>
